...
export const metadata: Metadata = {
  title: "Catálogo – Ivor Bearings Int",
...
export default function CatalogoPage() {
  return (
    <>
      <PageHero title="Explore nuestros catálogos" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {catalogs.map(({ title, img }) => (
              ...
              >
                ...
                <div className="px-5 py-5 border-t border-white/60">
                  <h2 className="font-semibold text-navy text-sm mb-4 leading-snug text-center">{title}</h2>
                  <a
                    href="#"
