...
function NewsletterForm() {
  ...
  return sent ? (
    <p className="text-sm text-white/90 font-medium">¡Gracias por suscribirte!</p>
  ) : (
    <form onSubmit={handleSubmit} className="flex mt-3 max-w-xs">
      <input
        ...
        placeholder="Email"
        className="flex-1 px-3 py-2 text-sm text-navy rounded-l-md focus:outline-none"
      />
      <button
        type="submit"
        className="bg-white/20 hover:bg-white/30 text-white text-sm font-semibold px-4 py-2 rounded-r-md transition-colors"
      >
        Enviar
      </button>
    </form>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/80">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:ventas@ivorbearingsint.com" className="hover:text-white transition-colors break-all">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/50769725465" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  +507-69725465
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <span>
                  ...
                  <a href="tel:+50747441129" className="hover:text-white transition-colors">+507-4744129</a>
                </span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>
                  ...
                  <a href="tel:+50739862044" className="hover:text-white transition-colors">+507-3986204</a>
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <ul className="space-y-1 text-sm text-white/80 mb-6">
